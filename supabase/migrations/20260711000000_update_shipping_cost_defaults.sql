-- 1. Alter default shipping cost for order drafts to 0
ALTER TABLE public.order_drafts ALTER COLUMN shipping_cost SET DEFAULT 0.00;

-- 2. Update legacy place_order RPC to use 0.00 default shipping cost
...
DECLARE
  ...
  v_shipping_cost NUMERIC(12,2) := 0.00; -- Changed from 99.00 to 0.00
